...
\tikzset{
    ...
    greenBox/.style={flowBox, fill=green!15, draw=green!40},
...
\begin{tikzpicture}[scale=0.75]
    ...
    % Total label
    \node[above, font=\small\bfseries, text=gray!80!black] at (1.2, 122*\unit) {$\sim$120};
...
\begin{tikzpicture}[scale=0.6]
    ...
    \node[draw=green!50, rounded corners, fill=green!15, minimum width=2.5cm, font=\tiny, drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.2}] (mbf_off) at (2,0) {bound\_updater};
...
\begin{tikzpicture}[scale=0.7,
    ...
    \node[font=\tiny\bfseries, text=gray!80!black] at (0,1.3) {State};
...
\begin{tikzpicture}[scale=0.7,
    box/.style={draw=gray!40, rounded corners, minimum width=2.8cm, minimum height=0.7cm, font=\scriptsize, line width=0.8pt},
    statebox/.style={draw=green!50, rounded corners, fill=green!15, minimum width=2.4cm, minimum height=1.2cm, font=\tiny, line width=0.8pt},
    flowarrow/.style={->, thick, gray!60}
]
    % Actor box
    \node[box, fill=green!15, draw=green!40, drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.2}] (actor) at (0,2.5) {Actor};
    ...
    \draw[flowarrow] (state) -- (compute);
    \draw[flowarrow] (compute) -- (transport);
    \draw[->, thick, gray!30, dashed] (transport) -- (skip1);
    \draw[->, thick, gray!30, dashed] (skip1) -- (skip2);
...
\begin{tikzpicture}[scale=0.95,
    ...
    tinylabel/.style={font=\small, text=gray!80!black}
]
    % Start
    ...
    \draw[red!70!black, thick] (skip2.west) -- (skip2.east);
    \node[process, fill=green!15, draw=green!40] (prop2) at (3.5,-2.3) {Propagate};
    ...
    \draw[->, thick, gray!30, dashed] (skip1) -- (skip2);
    \draw[->, thick, gray!30, dashed] (skip2) -- (prop2);
    ...
    % Compile-time badge
    \node[draw=blue!50, rounded corners, fill=blue!20, font=\small\bfseries, text=gray!80!black] at (0,-0.2) {Compile Time};
...
\begin{tikzpicture}[scale=1.1,
    ...
    \node[font=\LARGE\bfseries, text=gray!80!black] at (-3.2,1.5) {36.57};
    \node[font=\small, text=gray!60] at (-3.2,0.7) {events/s};

    \node[scorecard, fill=green!15, draw=green!50] (opt) at (3.2,1.5) {};
    ...
    \node[font=\large\bfseries, text=gray!80!black] at (-3.8,-1.2) {23.11 ms};
    ...
    \node[font=\normalsize, text=gray!80!black] at (3.8,-1.2) {V100-SXM2};
...
\begin{tikzpicture}[scale=0.9]
    ...
    \node[font=\large\bfseries, text=gray!80!black] at (0,1.9) {+11.67\%};
    ...
    % Isolated result
    \node[draw=green!50, rounded corners, fill=green!15, minimum width=2.8cm, minimum height=1.2cm, line width=0.8pt, drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.2}] at (0,-0.5) {};
...
\begin{tikzpicture}[scale=1.05,
    ...
    \node[biglabel, text=gray!80!black] at (-5,1.6) {128 $\rightarrow$ 96};
    ...
    \node[biglabel, text=gray!80!black] at (-1.5,1.6) {48.6\%};
    ...
    \node[biglabel, text=gray!80!black] at (2,1.6) {78.5M};
    \node[change, text=green!50!black] at (2,0.7) {$\downarrow$ 4.6\%};

    % Duration
    \node[card, fill=blue!10] (dur) at (5.5,1.5) {};
    \node[smalllabel] at (5.5,2.5) {DURATION};
    \node[biglabel, text=gray!80!black] at (5.5,1.6) {3.61 ms};
    ...
    \node[font=\normalsize\bfseries, text=gray!80!black] at (0.25,-0.5) {Dual Optimization Mechanism};

    % Left mechanism
    \node[draw=blue!40, rounded corners, fill=blue!15, minimum width=4.2cm, minimum height=0.7cm, font=\small, text=gray!80!black, line width=0.8pt] at (-2.5,-1.3) {Register Reduction};
    \node[font=\scriptsize, text=gray!60] at (-2.5,-1.9) {$\rightarrow$ Higher occupancy};

    % Right mechanism
    \node[draw=green!40, rounded corners, fill=green!15, minimum width=4.2cm, minimum height=0.7cm, font=\small, text=gray!80!black, line width=0.8pt] at (3,-1.3) {Instruction Reduction};
...
\begin{tikzpicture}[
    ...
    % No change indicator
    \node[draw=gray!40, rounded corners, fill=white, font=\scriptsize, text=gray!80!black, line width=0.8pt] at (-4,0) {No Change};

    % RTX 2080 Ti Panel (right) - highlighted
    \node[panel, fill=green!10, draw=green!50] (rtx) at (4,0) {};
    ...
    \node[font=\tiny, text=gray!80!black] at (3.1,0.5) {128};
    ...
    \node[font=\tiny, above, text=gray!80!black] at (0,0.2) {Different};
    \node[font=\tiny, below, text=gray!80!black] at (0,-0.2) {Compiler};
...
\begin{tikzpicture}[scale=0.85]
    % Title
    \node[font=\large\bfseries, text=gray!80!black] at (0,4) {Two Complementary Mechanisms};
    ...
    \node[font=\scriptsize, align=center, text=gray!80!black] at (-3.2,1.5) {128 $\rightarrow$ 96 registers\\(on sm\_75)};
    \node[font=\scriptsize\bfseries, text=blue!70!black] at (-3.2,0.6) {+9.3\% occupancy};

    % Mechanism 2 - Skipped Aggregation
    \node[draw=green!40, rounded corners=6pt, fill=green!15, minimum width=4.2cm, minimum height=2.2cm, line width=0.8pt, drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.25}] (mech2) at (3.2,1.5) {};
    \node[font=\small\bfseries, text=green!50!black] at (3.2,2.4) {Skipped Aggregation};
    \node[font=\scriptsize, align=center, text=gray!80!black] at (3.2,1.5) {No 6$\times$6 matrix mult\\No global memory I/O};
    \node[font=\scriptsize\bfseries, text=green!50!black] at (3.2,0.6) {-4.6\% instructions};

    % Combined effect
    \node[draw=green!50, rounded corners=6pt, fill=green!20, minimum width=5.5cm, minimum height=1.2cm, line width=0.8pt, drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.25}] (result) at (0,-0.7) {};
    ...
    % Per-track savings
    \node[draw=gray!40, dashed, rounded corners=4pt, fill=white, font=\tiny, align=center, text=gray!80!black, line width=0.8pt] at (0,-2.2) {
...
\begin{tikzpicture}[
    ...
    \node[value, text=gray!80!black] at (-2.8,1.2) {-36};
    \node[metric, text=gray!60] at (-5.5,0.4) {Occupancy:};
    \node[value, text=gray!80!black] at (-2.8,0.4) {+10-25\%};
    \node[metric, text=gray!60] at (-5.5,-0.4) {Throughput:};
    \node[value, text=gray!80!black] at (-2.8,-0.4) {+5-15\%};
    ...
    \node[panel, fill=green!15, draw=green!50] (hw) at (4,0.5) {};
...
\begin{tikzpicture}
    ...
    % Links
    \node[font=\normalsize, text=gray!80!black] at (0,-2) {\texttt{github.com/acts-project/traccc}};

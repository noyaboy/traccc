...
// ①  真正放在「CUDA 常量記憶體」的權重；在 Host 端就是一般 const 陣列
// ------------------------------------------------------------
TRACCC_DEVICE_CONSTANT TRACCC_ALIGN(4) inline std::int8_t W0[3840] = {
...
TRACCC_DEVICE_CONSTANT TRACCC_ALIGN(4) inline std::int8_t W1[2048] = {
...
TRACCC_DEVICE_CONSTANT TRACCC_ALIGN(4) inline std::int8_t W2[384] = {
